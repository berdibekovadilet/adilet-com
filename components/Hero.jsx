    ...
    return (
        <div className='my-16'>
            <h1 className="text-3xl md:text-[56px] leading-snug md:leading-tight">
                React Front-End Developer ✦ Currently enhancing digital banking solutions at <a
                href="https://smart.mbusiness.kg/" target="_blank" rel="noopener"
                className="underline underline-offset-8">MBusiness</a> ✦ Passionate
